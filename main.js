...
const login = require("./lib/fca-horizon-remastered");
...
try {
    ...
    if (existsSync(global.client.configPath.replace(/\.json/g,"") + "")) {
        configValue = readFileSync(global.client.configPath.replace(/\.json/g,"") + "");
        configValue = JSON.parse(configValue);
        logger.loader(`Found: ${global.client.configPath.replace(/\.json/g,"") + ""}`);
    }
